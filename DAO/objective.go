...
// 茶话会，一个具明确活动愿景、目标的茶叙活动；
// 在这应用里名称，茶话会=茶围=objective,寓意需要声明围炉品茶活动主题，有讨论范围，边界。
// 茶棚是n个茶话会的集合；茶围是n个从属茶台的集合。
// 规则1：如果class=1为开放式，则从属的茶台可以是开放式class=1，也可以是封闭式class=2；
// 规则2：如果class=2为封闭式，则从属的茶台都是封闭式class=2，仅限茶话会创建者邀请（指定）团队之成员可以创建新茶台；
type Objective struct {
	Id        int
	Uuid      string
	Title     string //标题
	Body      string //内容，茶话会活动主题，讨论涉及范围说明
	UserId    int    // 茶话会发起人，围主，创建人，作者
