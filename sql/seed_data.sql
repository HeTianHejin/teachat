...
(2, '070a7e98-d5ab-4506-4e59-093a053bc32b', '稻香老农', '李', '纨', '稻香老农', 'teachat-verifier@storetravels.com', 'df2983700ffecb52e6649f0cb3981b66537083a4', '我是见证团队，欢迎来到星际茶会！', 'traveller', 0, 'teaSet');

-- ============================================
-- 预设团队数据
-- ============================================

INSERT INTO teams (id, uuid, name, mission, founder_id, class, nature, abbreviation, logo, tags) VALUES
(1, '72c06442-2b60-418a-6493-a91bd03ae4k8', '自由人', '星际旅行特立独行的自由人，不属于任何$事业茶团。', 1, 0, 0, '自由人', 'teamLogo', '自由,独立'),
(2, 'dcbe3046-b192-44b6-7afb-bc55817c13a9', '茶棚服务团队', '飞船机组乘员茶棚服务团队，系统预设。', 1, 0, 1, '飞船茶棚', 'teamLogo', '系统团队,服务'),
(3, '38be3046-b192-44b6-7afb-bc55817c13c4', '见证者茶团', '见证者团队，为线下茶会活动作业担当主持见证人，系统预设。', 2, 0, 1, '见证者', 'teamLogo', '见证者,系统'),
(4, 'center-escrow-team-uuid', '茶庄服务中心', '处理茶庄事务，茶庄为线下茶会活动提供托管星茶服务，系统预设。', 1, 4, 1, '茶庄服务', 'teamLogo', '茶庄中心,系统'),
(5, 'public-governance-team-uuid', '公共治理团队', '处理公共治理事务，公共治理团队为系统预设的特殊团队，负责接收见证人对违规恶意/不道德行为的处罚罚没星茶，系统预设。', 1, 5, 1, '公共治理', 'teamLogo', '公共治理,系统');
...
INSERT INTO environments (name, summary,user_id, temperature, humidity, pm25, noise, light, wind, flow, rain, pressure, smoke, dust, odor, visibility) VALUES
('室内普通环境', '室内正常环境，温度适宜，光线较好，通风良好', 1, 3, 3, 5, 4, 2, 5, 5, 5, 3, 5, 5, 5, 4),
('室外晴朗天气', '室外正常环境，温度适宜，光线强烈，通风非常好', 1, 3, 3, 5, 4, 2, 5, 5, 5, 3, 5, 5, 5, 4),
('普通家庭', '普通的家庭环境，温度适宜，光线良好，通风良好', 1, 3, 3, 5, 4, 2, 5, 5, 5, 3, 5, 5, 5, 4),
('车辆维修车间', '一般的车辆维修车间，光线足，通风好，但有一些机械噪音，轻微尾气等', 1, 3, 3, 5, 4, 2, 5, 5, 5, 3, 5, 5, 5, 4),
...
INSERT INTO groups (id, uuid, name, abbreviation, mission, founder_id, first_team_id, class, nature, logo, tags)
VALUES (
    1,
    ...
    1,  -- 职业集团（GroupNatureProfessional）
    'groupLogo',
    '见证者集团,系统'
);
...
-- 记录『见证者茶团』(id=3) 加入『见证者集团』(id=1)
INSERT INTO team_group_memberships (group_id, team_id) VALUES
(1, 3);
...
('电力、热力、燃气及水生产和供应业', 'D', '电力、热力生产和供应业、燃气生产和供应业、水的生产和供应业'),
('建筑业', 'E', '房屋建筑业、土木工程建筑业、建筑安装业、建筑装饰装修和其他建筑业'),
('批发和零售业', 'F', '商品的批发、零售以及进出口贸易'),
('交通运输、仓储和邮政业', 'G', '铁路运输、道路运输、水上运输、航空运输、管道运输、多式联运、装卸搬运和仓储业、邮政业'),
('住宿和餐饮业', 'H', '住宿业、餐饮业'),
('信息传输、软件和信息技术服务业', 'I', '电信、广播电视和卫星传输服务、互联网和相关服务、软件和信息技术服务业'),
('金融业', 'J', '货币金融服务、资本市场服务、保险业、其他金融业'),
('房地产业', 'K', '房地产开发经营、物业管理、房地产中介服务、房地产租赁经营、其他房地产业'),
('租赁和商务服务业', 'L', '机械设备经营租赁、文体设备和用品出租、商业综合体管理服务、组织管理服务、综合管理服务、法律服务、会计审计税务服务等'),
('科学研究和技术服务业', 'M', '研究和试验发展、专业技术服务业、科技推广和应用服务业'),
('水利、环境和公共设施管理业', 'N', '水利管理业、生态保护和环境治理业、公共设施管理业、土地管理业'),
('居民服务、修理和其他服务业', 'O', '居民服务业、机动车电子产品和日用产品修理业、其他服务业'),
('教育', 'P', '学前教育、初等教育、中等教育、高等教育、特殊教育、技能培训、教育辅助及其他教育'),
('卫生和社会工作', 'Q', '卫生、社会工作'),
...
SELECT setval('industry_tags_id_seq', (SELECT MAX(id) FROM industry_tags));
