...
## 简介
这是一个个人设计用来 ~~争吵~~ ~~抬杠~~ 辩论的是非论坛类Web应用，可以叫星际茶棚@茶话会。  
尝试通过糅合目前的论坛和社交应用的特点，同时提供一些不同以往的功能，以期望可以走出原地打转的茧房陷阱。  
假作真时真亦假，为了避免搬弄是非变成明辨是非，采用圆桌会议人人都有形式上平等重要性布局，内容过滤基于*慎独*思想构造。
...
按船长的意愿，此茶棚活动的形式，适合讨论一些内容玄虚飘渺，吵得再大声也不会伤和气那种话题，特别是那种不好硬核衡量的一些看法（观点），比如：
#### 平安无事类  
>>1、惠来绿豆饼是世界上最好的茶点。依据是便宜量足，味道清香最佳茶侣没有对饼。  
2、招呼不同的朋友需要不同的茶。如果你拥有许多茶，说明最近你的财富增长速度远超朋友数量增长速度。

#### 偏执狂类
>>1、 按照事实来说 *go* 无论是目测还是结构分析都是最接近 *god* 的编程语言。你看，“g”像是低头的码字人，“o”是他脑后的光晕，由此可见，gopher都是自带光环的人。   
2、AI是程序员设计的，终极目标是下架程序员，这有一点割肉喂鹰的悟道意思。

#### 甚至：无事生非类  
>>1、找中介买房子，是按标的成交价的3%来计算报酬的。所以找师傅疏通堵塞的马桶，也应当按别墅的总市价3%来计算人工服务费才合情合理。  
2、美国的总统当选上任时，需要手按圣经发誓诚实守信。然而在竞选阶段，总统候选人公开发言却可以用伪证式宣言拉票，例如夸大诋毁非法移民犯罪率。这难道不是前后矛盾？  

诸如此类，保持优雅姿势可品味又不影响喝茶心情的话题。  
...
图文并茂配源码讲解，如获至宝，认为这是天机种子，能当大任，以此应用为起始基础，开始浇水，添枝加叶，修修剪剪……  
...
3、个人认为星际茶棚@茶话会（teaBar on starship@teachat）是一个茶话会和论坛的交集实例。
